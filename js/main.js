...
const PRODUCT_DETAIL_DATA = {
  ...
  'anti-mold': {
    title: '截切抗黴保護劑【實驗中，結果統計中】',
    category: '農業化材',
    categoryClass: 'badge-chem',
    icon: '<i class="fa-solid fa-shield-halved"></i>',
    desc: '本產品目前正處於田間與外銷貨櫃對照實驗階段。針對外銷海運過程中貨櫃內溫濕度變化劇烈、鳳梨蒂切口易感染黴菌發霉的痛點進行效果驗證。相關防霉抑制率與海運保鮮天數等實測數據目前正在統計彙整中，正式發表前暫不公開。',
    specs: [
      { label: '當前狀態', value: '田間與外銷貨櫃實驗中' },
      { label: '數據統計', value: '結果彙整中，暫不公開' }
    ],
    cases: []
  },
  'uv-solvent': {
